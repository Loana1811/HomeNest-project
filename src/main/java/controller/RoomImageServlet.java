...
//                response.setContentType("image/jpeg"); // hoặc image/png tùy loại ảnh
//                response.setContentLength(imageData.length);
                response.setContentType("image/jpeg"); // hoặc image/png nếu biết rõ
                response.setHeader("Content-Disposition", "inline; filename=\"room_" + id + ".jpg\"");
