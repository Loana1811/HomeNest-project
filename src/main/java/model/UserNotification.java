...
public class UserNotification {
    ...
    public UserNotification(int userNotificationID, int userID, String userTitle, String userMessage, boolean isRead,
            Timestamp userNotificationCreatedAt, Integer sentBy) {
