    ...
    <body>
        ...
        <script>
            document.addEventListener("DOMContentLoaded", function () {
                ...
                // Simple MD5 function for demo (không bảo mật, chỉ dùng cho client check)
                // Nên dùng thư viện CryptoJS (nếu cần bảo mật thực sự thì check ở server)
                function md5(str) {
                    // Simple, lightweight, chỉ so sánh demo thôi!
                    // Nên import CryptoJS real nếu muốn đúng 100%
                    // Ở đây bạn thay bằng md5 của password cũ truyền xuống, vẫn đảm bảo không lộ pass
                    // Nếu không cần check thật client-side thì bỏ qua dòng này, chỉ check ở server
                    return CryptoJS.MD5(str).toString();
                }
            });

        // Nhúng CryptoJS cho MD5 (hoặc bỏ qua phần check md5 nếu không quan trọng client-side)
        </script>
