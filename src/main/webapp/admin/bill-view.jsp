...
<%
    ...
    out.println("Room rent: " + roomRent + "<br>");
    out.println("Utility total: " + utilityTotal + "<br>");
    out.println("Fee total: " + feeTotal + "<br>");
    out.println("Deposit: " + deposit + "<br>");
    out.println("Is last month: " + isLastMonth + "<br>");
%>
            ...
            <table class="table table-bordered mt-4">
                ...
                <tbody>
                    ...
                    <c:if test="${isLastMonth}">
                        <tr>
                            <td>Tiền cọc trừ</td>
                            <td><fmt:formatNumber value="<%= deposit%>" type="number" maxFractionDigits="0"/> đ</td>
                        </tr>
                    </c:if>

                    <tr class="total-row">
                        <td>Tổng cộng</td>
                        <td><fmt:formatNumber value="<%= totalAmount%>" type="number" maxFractionDigits="0"/> đ</td>
                    </tr>
                    <tr class="total-row">
                        <td>Số tiền phải thu</td>
                        <td><fmt:formatNumber value="<%= dueAmount%>" type="number" maxFractionDigits="0"/> đ</td>
                    </tr>
                    <tr class="total-row">
                        <td>Trạng thái</td>
