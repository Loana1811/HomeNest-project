...
<html>
    ...
    <body>
        ...
        <%
            ...
            List<UserNotification> userNotifications = (List<UserNotification>) request.getAttribute("userNotifications");
        ...
        <div class="container mt-5">
            ...
            <div class="alert alert-info">
                ...
                <ul>
                    ...
                    <li>
                        <strong><%= n.getUserTitle() %></strong>: <%= n.getUserMessage() %><br/>
                        <small><%= n.getUserNotificationCreatedAt() %></small>
                    </li>
                    <% } %>
                </ul>
            </div>
