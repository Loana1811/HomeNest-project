    ...
    <div class="container-profile">
        ...
        <div class="profile-body">
            ...
            <div id="viewSection">
                ...
                <div class="row"><div class="col-md-4 label">Birthday:</div><div class="col-md-8 value"><%= customer.getBirthDate() != null ? sdf.format(customer.getBirthDate()) : "N/A"%></div></div>
            ...
            <form id="editSection" action="<%= request.getContextPath()%>/update-profile" method="post" style="display:none;">
                ...
                <div class="row"><div class="col-md-4 label">Birthday:</div><div class="col-md-8"><input type="date" class="form-control" name="birthDate" value="<%= customer.getBirthDate() != null ? sdf.format(customer.getBirthDate()) : ""%>"></div></div>
