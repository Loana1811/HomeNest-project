...
<html lang="en">
    ...
    <body>
        <div class="container">
            ...
            <h3>Notifications Sent by You</h3>
            <div class="notification-table">
                <table class="table table-striped">
                    <thead>
                        <tr>
                    ...
                    <tbody>
                        <c:choose>
                            <c:when test="${not empty sentNotifications}">
                                <c:forEach var="n" items="${sentNotifications}">
                                    <c:set var="customer" value="${customerMap[n.customerID]}"/>
                                    <tr>
                                        <td>${n.notificationID}</td>
                                        <td>${customer != null ? customer.customerFullName : 'Unknown Customer'}</td>
                                        <td>${fn:escapeXml(n.title)}</td>
                                        <td>${fn:escapeXml(n.message)}</td>
                                        <td>${n.notificationCreatedAt}"</td>
                                    </tr>
                                </c:forEach>
                            </c:when>
                            <c:otherwise>
                                <tr>
                                    <td colspan="5" class="empty-state">
                                        <i class="fas fa-paper-plane"></i><br>No notifications sent by you yet.
                                    </td>
                                </tr>
                            </c:otherwise>
                        </c:choose>
