                    ...
                    <div class="col-md-4">
                        <div class="form-floating mb-3">
                            <select id="customerStatus" name="status" class="form-select" required>
                                ...
                                <option value="Disable" <c:if test="${customer.customerStatus == 'Disable'}">selected</c:if>>Inactive</option>
                            </select>
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function () {
            ...
            form.addEventListener('submit', function (e) {
                ...
                if (cccd !== "") {
                    if (!/^\d{12}$/.test(cccd)) {
                        showError(cccdInput, "CCCD must be exactly 12 digits.");
                        isValid = false;
                    } else {
                        let firstThree = parseInt(cccd.substring(0, 3));
                        if (firstThree < 1 || firstThree > 96) {
                            showError(cccdInput, "Invalid CCCD: First three digits must be between 001 and 096.");
                            isValid = false;
                        } else {
                            hideError(cccdInput);
                        }
                ...
                if (birthDateInput.value) {
                    ...
                    if (age < 15) {
                        showError(birthDateInput, "Customer must be at least 15 years old.");
                        isValid = false;
                    } else if (age > 100) {
                        showError(birthDateInput, "Customer must not be older than 100 years.");
                        isValid = false;
                    } else {
