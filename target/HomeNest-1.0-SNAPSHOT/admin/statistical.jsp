    ...
    <body class="container-fluid mt-4">
        <div class="row">
            ...
            <div class="col-md-9">
                ...
                <!--         Nút Import nằm ở hàng riêng phía trên, căn phải -->
                <div class="dropdown mb-4 text-end">
                    <button class="btn btn-outline-primary dropdown-toggle" type="button" data-bs-toggle="dropdown">
                        <i class="bi bi-upload"></i> Import thu/chi
                    </button>
                    <ul class="dropdown-menu dropdown-menu-end">
                        <li><h6 class="dropdown-header">Chọn định dạng</h6></li>
                        <li><a class="dropdown-item" href="template/import-revenue-expense.xlsx">
                                <i class="bi bi-file-earmark-excel text-success me-2"></i>Tải template Excel
                            </a></li>
                        <li><a class="dropdown-item" href="#" onclick="document.getElementById('importExcelFile').click();">
                                <i class="bi bi-upload text-primary me-2"></i>Import từ Excel
                            </a></li>
                    </ul>
                ...
                <form method="get" class="row g-3 align-items-center mb-3">
                    <!-- Giữ lại các tham số lọc thời gian -->
                    ...
                    <div class="col-auto">
                        ...
                        <!-- Danh mục thu (chỉ hiện nếu lọc theo income hoặc all) -->
                    ...
                    <!-- Danh mục chi (chỉ hiện nếu lọc theo expense hoặc all) -->
                ...
                <div class="d-flex flex-wrap gap-3 mb-4">
                    ...
                    <!--            <div class="stat-box border text-warning">
                                    <div>Dư nợ hiện tại</div>
                                    <h4 class="mt-2">${totalDebt} đ</h4>
                                </div>-->
                </div>
                ...
                <div class="d-flex flex-wrap gap-2 mb-4">
                    ...
                    <button class="btn btn-outline-success btn-action"><i class="bi bi-file-earmark-excel"></i> Xuất Excel</button>
                    <button class="btn btn-outline-secondary btn-action"><i class="bi bi-printer"></i> In báo cáo</button>
                </div>
                ...
                <!-- Modal Danh mục thu dạng thẻ đẹp hiện đại -->
                ...
                <!-- Modal Danh mục chi dạng thẻ đẹp hiện đại -->
                        ...
                        <table class="table table-bordered align-middle text-center">
                            ...
                            <tbody>
                                ...
                                <c:if test="${empty transactions}">
                                    <tr>
                                        <td colspan="8" class="text-muted">Chưa có dữ liệu thu/chi nào.</td>
                                    </tr>
                                </c:if>
                            </tbody>
                        </table>
